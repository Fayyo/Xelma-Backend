...
| `npm run dev:hackathon` | `src/server.ts` | Demo/hackathon server — mock data mode |
...
```bash
# Demo/hackathon server — mock data mode
...
| `DATA_MODE` | `mock` | Use mock data mode (queries Drizzle schema tables) |
